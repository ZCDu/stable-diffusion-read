...
# NOTE: 所有的路由都定义在这里类里, 并且需要进行功能的注册
# FIX: 是否可以在其他位置进行路由接口的定义，这样能过更好地扩展，而不需要修改源码
class Api:
    ...
    # NOTE: 这里的参数形式就是依据fastapi的格式进行的，后一个就是Pydantic类型
    def text2imgapi(self, txt2imgreq: models.StableDiffusionTxt2ImgProcessingAPI):
        ...
        # NOTE: 这里进行了排队，所以一次是只能执行一张图片的
        with self.queue_lock:
            # NOTE: shared定义的是模型相关的参数
