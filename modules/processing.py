...
class StableDiffusionProcessing:
    ...
    batch_size: int = 1    # 每次生成的图片数量
    n_iter: int = 1   # 生成批次，不知道什么意思
    steps: int = 50
    cfg_scale: float = 7.0
    width: int = 512
    height: int = 512
    restore_faces: bool = None      # 是否启动脸部修复，原来这里就内置了2个修脸的，只是我没有启动
    tiling: bool = None        # 可平铺
    ...
    sampler_index: int = None       # 采样方法  Euler
    refiner_checkpoint: str = None      # Refiner模型
